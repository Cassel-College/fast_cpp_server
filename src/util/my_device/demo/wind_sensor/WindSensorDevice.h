...
class WindSensorDevice final : public my_device::IDevice {
public:
  WindSensorDevice();
  WindSensorDevice(const nlohmann::json& cfg, std::string* err);
  ~WindSensorDevice() override;
...
private:
  my_data::DeviceId device_id_{"split-unknown"};
