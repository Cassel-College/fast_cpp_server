...
public:
    ...
    ENDPOINT("POST", "/v1/cache/upload", uploadFile, BODY_STRING(oatpp::String, body));
    ...
    ENDPOINT("POST", "/v1/cache/query", queryFile, BODY_STRING(oatpp::String, body));
    ...
    ENDPOINT("POST", "/v1/cache/delete", deleteFile, BODY_STRING(oatpp::String, body));
    ...
    ENDPOINT("POST", "/v1/cache/list", listFiles, BODY_STRING(oatpp::String, body));
