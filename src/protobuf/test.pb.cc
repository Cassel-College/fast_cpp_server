    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "MyProto.Person.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 id = 2;
...
template<> PROTOBUF_NOINLINE ::MyProto::Person*
Arena::CreateMaybeMessage< ::MyProto::Person >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyProto::Person >(arena);
}
