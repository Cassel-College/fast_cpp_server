...
set_target_properties(MAVSDK::mavsdk PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:LibLZMA::LibLZMA>;\$<LINK_ONLY:CURL::libcurl_static>;\$<LINK_ONLY:atomic>;dl;\$<LINK_ONLY:JsonCpp::JsonCpp>;\$<LINK_ONLY:tinyxml2::tinyxml2>;\$<LINK_ONLY:LibEvents::LibEvents>;\$<LINK_ONLY:mav::mav>"
)
